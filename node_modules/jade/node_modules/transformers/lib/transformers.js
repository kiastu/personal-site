...
exports.uglifyCSS = exports['uglify-stylesheets'] = new Transformer({
  name: 'uglify-stylesheets',
  engines: ['.'],
  outputFormat: 'css',
  isMinifier: true,
  sync: function (str, options) {
...
exports["cdata-stylesheets"] = new Transformer({
  name: 'cdata-stylesheets',
  engines: ['.'],// `.` means "no dependency"
  outputFormat: 'xml',
  sync: function (str, options) {
    var escaped = str.replace(/\]\]>/g, "]]]]><![CDATA[>");
...
exports['component-stylesheets'] = new Transformer({
  name: 'component-stylesheets',
  engines: ['component-builder'],
  outputFormat: 'css',
  async: function (str, options, cb) {
    if (this.cache(options)) return this.cache(options);

 ...
 *    `dest`      Destination directory used to output .stylesheets files,
 *                a string or function accepting `(path)` of request,
 *                when undefined defaults to `src`.
 *    `compile`   Custom compile function, accepting the arguments
 *                `(str, path)`.
 *    `compress`  Whether the output .stylesheets files should be compressed
 ...
 * and saving .stylesheets files to _./public_. Also supplying our custom `compile` function.
 * 
 * Following that we have a `static()` layer setup to serve the .stylesheets
